...
passport.deserializeUser((id, done)=>{
    ...
    // });
    connection.query('SELECT login.id, login.username, users.first_name, users.last_name, users.email, users.role FROM users INNER JOIN login ON users.id = login.user_id WHERE login.id = '+id, (err, rows) => {
