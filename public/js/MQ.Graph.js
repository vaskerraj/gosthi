...
(function($){
    ...
    $.MQGraph = {
        init : function() {
            ...
            $.MQGraph.ppath();
            $.MQGraph.inputFocusState(inputFocusStateSel);
            $.MQGraph.inputMask();
            $.MQGraph.notifiMsgHandler();
            $.MQGraph.relaodDataInSec($countSecondSelector);
            // $.MQGraph.datepickerHandler();
			$.MQGraph.customReport($custommReportSelector);
			$.MQGraph._compareReport.init();
